...
def get_readable_time(seconds: int) -> str:
    ...
    return ping_time
PM_START_TEXT = """
`𝙷𝚎𝚕𝚕𝚘` [👿](https://telegra.ph/file/b1ae67fad00c60d51a5f2.jpg) `I Am a` *Group Manager bot*
`I am here to help you group With different Types! Click` *Comments*   to more
"""
buttons = [
    [
        InlineKeyboardButton(
            text="𝐀𝐝𝐝 𝐌𝐞 𝐓𝐨 𝐘𝐨𝐮𝐫 𝐏𝐥𝐚𝐜𝐞😇", url="t.me/Z_Grp_Manager_bot?startgroup=true"),
    ],
     [
        InlineKeyboardButton(text="𝐀𝐛𝐨𝐮𝐭💝", callback_data="evil_"),
        InlineKeyboardButton(
            text="𝐌𝐲 𝐖𝐞𝐛🌐", url=f"http://Z_Grp_Manager_bot.art.blog"
        ),
     ],
     [  
        InlineKeyboardButton(text="Support🛠", url="https://t.me/botzsupport"),
        InlineKeyboardButton(text="Repo🇮🇳", url="https://github.com/selfie-bd/EvilBot"),
    ], 
...
HELP_STRINGS = """
`Hey!.. I am` 👿 *Z_Grp_Manager_bot* [👿](https://telegra.ph/file/a064bd8497a5f6f03b290.mp4)
...
DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project via [Paypal](#) or by contacting @selfiebd \
        ...
        query.message.edit_text(
            text=""" ℹ️ I'm powerful group management bot built to help you manage your group easily.
                 ...
                 \n\n_My licensed under the GNU General Public License v3.0_ 
                      here is this [Repository](https://github.com/selfie-bd/EvilBot) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Back", callback_data="Z_Grp_Manager_bot")
                 ]
                ]
            ),
        )
    elif query.data == "Z_Grp_Manager_bot":
        query.message.edit_text(
                PM_START_TEXT,
                reply_markup=InlineKeyboardMarkup(buttons),
                parse_mode=ParseMode.MARKDOWN,
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hey!.. I'm *Group Manager bot*
                 \nHere is the [Source Code](https://github.com/selfie-bd/EvilBot) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 1362428873 and DONATION_LINK:
            update.effective_message.reply_text(
